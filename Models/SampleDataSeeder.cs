    ...
    public static class SampleDataSeeder
    {
        ...
        private static async Task ApplyCuscoWorkshopRosterAsync()
        {
            ...
            if (cuscoLab != null)
            {
                ...
                {
                    """Welcome: V60 in hand, walk the lab|8 min||<ul class="tour-syllabus-points"><li><strong>00:00–00:05 · Welcome &amp; V60</strong> — Welcome guests into the lab and hand them a pre-brewed V60 to sip as they settle in.</li><li><strong>00:05–00:08 · Laboratory tour</strong> — Walk the space: roasting setup, espresso bars, and coffee testing equipment.</li></ul>""",
                    """Part 1: You brew a V60|43 min||<ul class="tour-syllabus-points"><li><strong>00:08–00:14 · Intro to filtered coffee</strong> — Question: “¿Cuál es un filtrado? What is a filtered coffee?” A filtered coffee is made with grounds where water flows through a porous material — clean and lighter, a sharp contrast to espresso.</li><li><strong>00:14–00:16 · Equipment</strong> — Kettle, grinder, scale, filters, and drippers. Point out the range on the bench: Origami, V60, V70, Tornado, and the rest.</li><li><strong>00:16–00:24 · Instructor demonstration</strong> — Walk the brew with everything pre-staged (grounds ready, water hot). Hand out recipe cards so guests can follow visually.</li><li><strong>00:24–00:26 · The coffee</strong> — Origin, roast profile, and flavor notes of the lot they are about to brew.</li><li><strong>00:26–00:46 · Hands-on</strong> — Cue: “Everybody to your station. Follow my instructions and use your recipe card.”<ol class="tour-syllabus-steps"><li>Warm water to 86°C (push the kettle button).</li><li>Put your beans into the grinder (grind size is already preset).</li><li>Purge (rinse) the paper filter with hot water.</li><li>Server on the scale, dripper on top. Tare to zero. Grounds into the dripper.</li><li>Weigh exactly 15 g of coffee. Tare again.</li><li>At 86°C, bloom: 45 g of water. Wait 1 minute.</li><li>Before the dripper empties, second pour: +100 g (scale reads 145 g).</li><li>Before it empties again, final pour of 90 g (scale reads 235 g).</li></ol></li><li><strong>00:46–00:51 · Taste</strong> — Cue: “Try it!” Taste each other’s brews and talk about why a cup came out the way it did.</li></ul>""",
                    """Part 2: Espresso & milk|45 min||<ul class="tour-syllabus-points"><li><strong>00:51–00:57 · Intro &amp; tools</strong> — Question: “What can we make with an espresso machine?” Beyond a straight espresso: milk drinks like a cappuccino and a flat white. Tools: espresso machine, portafilter, grinder, scale, filter basket, WDT, tamper, and milk jug.</li><li><strong>00:57–01:27 · Pull a shot, then milk</strong> — Portafilter on the scale, zero it. Dose exactly 18 g from the grinder. WDT to distribute. Tamp straight down, firm and even. Scale on the drip tray, lock the portafilter, cup on the scale, zero it. Start the shot and the timer together. Stop at the recipe weight (about 36 g in 25–30 seconds). Purge the steam wand, texture cold milk to glossy microfoam, and pour a cappuccino or flat white.</li><li><strong>01:27–01:36 · Practice &amp; tasting</strong> — Guests pull their own shots, steam milk, build the drink at their station, and drink it.</li></ul>""",
                    """Part 3: Roast a batch to take home|54 min||<ul class="tour-syllabus-points"><li>We run a batch roast together and cover the fundamentals of the roasting process.</li><li>Everyone leaves with 160 grams of that coffee.</li></ul>"""
                };
            }
